...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        ...
        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            Administre o quadro societário no sistema, nosso Quadro Societário representa uma comunidade de colaboradores dedicados, cada um trazendo uma perspectiva única e habilidades valiosas para o sucesso conjunto.
        </p>
